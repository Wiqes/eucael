...
@Component({
  ...
  template: `
    <svg xmlns="http://www.w3.org/2000/svg" width="90" height="28" viewBox="0 0 90 28" fill="none">
      ...
      />
      <!-- I  -->
      <rect x="18" y="6" width="3.5" height="16" rx="1.5" fill="#34d399" />
      <rect x="18" y="2" width="3.5" height="2.5" rx="1.25" fill="#34d399" />
      <!-- Q (moved left to decrease space between I and Q) -->
      <ellipse cx="31.5" cy="14" rx="6" ry="7.5" fill="none" stroke="#34d399" stroke-width="2" />
      <ellipse cx="31.5" cy="14" rx="4.5" ry="6" fill="none" stroke="#34d399" stroke-width="2" />
      <path d="M35.5 19.5L39 24" stroke="#34d399" stroke-width="2" stroke-linecap="round" />
